...
export type LaunchesQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'upcoming' | 'launch_year' | 'launch_date_local' | 'launch_success'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
...
export type LaunhDetailQueryVariables = Exact<{
  id?: Maybe<Scalars['String']>;
}>;


export type LaunhDetailQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'details' | 'mission_name' | 'launch_date_local' | 'launch_success'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
...
export const LaunhDetailDocument = gql`
...
/**
 * __useLaunhDetailQuery__
 *
 * To run a query within a React component, call `useLaunhDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunhDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLaunhDetailQuery(baseOptions?: Apollo.QueryHookOptions<LaunhDetailQuery, LaunhDetailQueryVariables>) {
        return Apollo.useQuery<LaunhDetailQuery, LaunhDetailQueryVariables>(LaunhDetailDocument, baseOptions);
      }
export function useLaunhDetailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunhDetailQuery, LaunhDetailQueryVariables>) {
          return Apollo.useLazyQuery<LaunhDetailQuery, LaunhDetailQueryVariables>(LaunhDetailDocument, baseOptions);
        }
export type LaunhDetailQueryHookResult = ReturnType<typeof useLaunhDetailQuery>;
export type LaunhDetailLazyQueryHookResult = ReturnType<typeof useLaunhDetailLazyQuery>;
export type LaunhDetailQueryResult = Apollo.QueryResult<LaunhDetailQuery, LaunhDetailQueryVariables>;